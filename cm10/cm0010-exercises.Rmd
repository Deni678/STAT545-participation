...
```{r}
time %>% 
  # preserve everything in base tibble but then add in info from other tibble if available
  # left_join is a 
  left_join(album, c("song","artist_name"))
```
