...
1. title
1. axis labels
1. good scale on the axes
1. appropriate type of plot
1. colour
...
- <<Do not know- graph does not say anything about motivation>>

- Main takeaway: Summarize the main takeaway from this question/discussion here
Not a good use of space. The EU is pretty big and the changes in working hours are relatively small.
Axes not started at 0. 
...
- Main takeaway: Summarize the main takeaway from this question/discussion here
The graph's x axis is not labeled so we don't know the range on the x-axis
Y axis range is big. 
You need scientific knowledge to be able to interpret these graphs.E.g. you need to know that 2C increase is big.
...
- <<very weak- axis is upside down>>

- Main takeaway: Summarize the main takeaway from this question/discussion here
Axis is upside down-> increase in gun deaths not decrease
...
Factor of 100 difference on the axes
