...
```{r}
# select - takes columns of choice
...
```{r}
# compare
# select doesn't change the name of the column but rename() does
...
gapminder %>%
  filter(pop >100000000) %>%
  filter(continent=='Asia' | continent== 'South America') %>%
